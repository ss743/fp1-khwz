...
\gra[0.5]{TAC}{Funktionsweise des TAC $^{\cite{anleitung}}$}
...
Für die aufgenommenen Kobaltspektren haben wir ebenfalss Gaußkurven an die Peaks gefittet:
...
Für die nächsten Versuchsteile verwenden wir Orienierung 1 der Probe und messen den $14.4$ keV-Peak mit dem rechten Szintillator und den $122$ keV-Peak mit dem linken Oszillator.
\newpage
...
In Abbildung \ref{original} sind die Messdaten der Hauptmessung als Counts über Channel aufgetragen. Wir haben dabei die ersten 50 Channel vernachlässigt, da wir in diesem Bereich mehrere Ausreißer beobachten konnten. Über die Zeitkalibrierung können die Channel später in Zeiten umgerechnet werden.
