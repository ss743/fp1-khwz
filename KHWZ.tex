...
Ein Single Channel Analyser selektiert aus eingehenden Signalen in dem nur für Energien in einem einstellbaren Energiefenster ein Ausgangspuls erzeugt wird.
\paragraph{Time to Amplitude Converter (TAC)} Der Time to Amplitude Converter erzeugt einen in der Höhe  zur Zeitdifferenz zwischen Start- und Stoppsignal proportionalen Rechteckpuls.
...
\vskip 30 pt
Das Spektrum von $^{241}$Am dient zur Energiekalibrierung. Hierzu werden die Peaks des Americiumspektrums den einzelnen Zerfällen des Zerfallsschemas zugeordnet und so der Kalibrierungsfaktor zwischen der Energie und der Channelanzahl bestimmt. Dies dient dann zur Identifizierung der $^{57}$Fe-Peaks.
...
\vskip 50 pt
\gra{Schaltung_3}{Versuchsaufbau 3: Messen der verzögerten und zufääligen Koinzidenzen}
\vskip 30 pt
